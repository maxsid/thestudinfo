    ...
    <table style="border: none;font-size: 12px;color: #5b5b5b;width: 100%;margin: 10px 0 10px 0;">
        ...
        if (is_null($lessons)) {
            ...
            foreach ($lessons as $key => $les) {
                ...
                $group = $les->getGroup();
                $evaluation = $les->getAverageEvaluation();
                $omissions = $les->getCountOmissions();
                print "
        <tr>
            <td style='border: none;padding: 4px;'>$discipline->name</td>
            <td style='border: none;padding: 4px;'><b>$group->name</b></td>
            ...
            <td style='border: none;padding: 4px;'><b>$omissions</b></td>
        </tr>
            ";
            }
        }
